...
@elseif($canEditSpot)
    <div class="d-flex gap-2">
        ...
        <form action="{{ route('tourist_spots.destroy', $spot->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this tourist spot? This action cannot be undone.');">
            @csrf
            @method('DELETE')
...
<style>
    ...
    .spot-description h5 { color: #0f766e; margin-bottom: .75rem; }
    .spot-description-content {
        max-width: 72ch;
        margin: 0;
        color: #374151;
        font-size: 1.05rem;
    ...
    .spot-description-content.is-empty { color: #6b7280; font-style: italic; }
    ...
    <div class="col-lg-8">
        <div class="card mb-4">
            <div class="card-body p-4">
                ...
                <section class="spot-description" aria-labelledby="spot-description-heading">
                    <h5 id="spot-description-heading"><i class="fas fa-align-left me-2"></i>Description</h5>
                    <p class="spot-description-content {{ blank($spot->description) ? 'is-empty' : '' }}">{{ $spot->description ?: 'No description available.' }}</p>
                </section>
            </div>
        </div>
